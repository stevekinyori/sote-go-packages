...
const (
	...
	ErrItemAlreadyUpdated                    = 100200
	ErrCancelOrComplete                      = 100500
	ErrInactiveItem                          = 100600
	ErrTimeout                               = 101010
	ErrContextCancelled                      = 101020
	ErrContextDeadlineExceeded               = 101025
	ErrItemNotFound                          = 109999
	ErrGenericError                          = 199999
	ErrInvalidTable                          = 200100
	ErrInvalidParameterType                  = 200200
	ErrInvalidParameterValue                 = 200250
	ErrMissingConditionalParameter           = 200260
	ErrConditionalNonUpdatableParameter      = 200510
	ErrExpectedTwoParametersOrNull           = 200511
	ErrExpectedTwoParameters                 = 200512
	ErrMissingParameters                     = 200513
	ErrExpectedThreeParameters               = 200514
	ErrConditionalEmptyFieldError            = 200515
	ErrBadHTTPRequest                        = 200600
	ErrInvalidAPI                            = 200700
	ErrQuicksightError                       = 200800
	ErrDatabaseConstraintError               = 200900
	ErrSQLError                              = 200999
	ErrCognitoError                          = 201999
	ErrErrorMsgParameterCountMismatch        = 203000
	ErrUnsupportedParameterCount             = 203050
	ErrInvalidParameterCount                 = 203060
	ErrAWSSESError                           = 205000
	ErrAWSSTSError                           = 205005
	ErrDisabledJetstream                     = 206000
	ErrNATSInvalidSubscription               = 206050
	ErrMissingKey                            = 206100
	ErrMissingKeyValue                       = 206105
	ErrInvalidMsgSignature                   = 206200
	ErrNilStreamPointer                      = 206300
	ErrStreamCreationFailure                 = 206400
	ErrConsumerCreationFailure               = 206600
	ErrInvalidConsumerSubjectFilter          = 206700
	ErrNotNumeric                            = 207000
	ErrNotMinimumLength                      = 207005
	ErrNotString                             = 207010
	ErrNotFloat                              = 207020
	ErrNotArray                              = 207030
	ErrNotJSONString                         = 207040
	ErrInvalidEmail                          = 207050
	ErrForbiddenSpecialCharacters            = 207060
	ErrOnlyUnderscoreSpecialCharacterAllowed = 207065
	ErrInvalidDate                           = 207070
	ErrInvalidTimestamp                      = 207080
	ErrInvalidSize                           = 207090
	ErrMustBeGreaterOrLessThan               = 207095
	...
	ErrUnnecessaryRecordUpdate               = 208110
	ErrMissingJSONRecordKeyValue             = 208120
	ErrMissingErrorMessage                   = 208200
	ErrInvalidTokenISS                       = 208300
	ErrMissingTokenSubject                   = 208310
	ErrInvalidTokenUse                       = 208320
	ErrInvalidTokenClientId                  = 208330
	ErrInvalidAppClientId                    = 208340
	...
	ErrMissingEnvFile                        = 209000
	ErrMissingFile                           = 209010
	ErrMissingEnvVariable                    = 209100
	ErrInvalidEnvValue                       = 209110
	ErrInvalidDBConnectionPort               = 209200
	ErrDBAuthenticationFailure               = 209210
	ErrInvalidSSLMode                        = 209220
	ErrInvalidConnectionType                 = 209230
