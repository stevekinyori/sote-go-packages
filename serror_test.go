...
func TestIncorrectParams(t *testing.T) {
	...
	if x := serror.GetSError(100100, paramValues, []string{""}); x.ErrCode != 230060 {
...
func TestErrorCodeNotFound(t *testing.T) {
	errCode := 999999999
	if x := serror.GetSError(errCode, nil, []string{""}); x.ErrCode != 410000 {
...
func Test100100Error(t *testing.T) {
	...
	validateReply(t, errCode, paramValues, serror.GetSError(errCode, paramValues, []string{""}))
}
