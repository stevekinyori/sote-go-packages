...
func TestGetDBPassword(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBPassword("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
...
func TestGetDBName(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBName("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
...
func TestGetDBHost(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBHost("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
...
func TestGetDBPort(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBPort("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
...
func TestGetDBSSLMode(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBSSLMode("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
...
func TestGetDBUser(t *testing.T) {
	...
	if _, soteErr := sConfigParams.GetDBUser("SCOTT", sConfigParams.STAGING); soteErr.ErrCode == nil {
